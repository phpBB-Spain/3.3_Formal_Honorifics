...
$lang = array_merge($lang, array(
	...
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Mostrar mensajes no aprobados al autor',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Los mensajes no aprobados pueden ser vistos por el autor. No se aplica a los mensajes de invitados.',
...
//	'ACC_USER_ADMIN'			=> 'Usuario + Admin',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'Número mínimo de caracteres en las contraseñas. Tenga en cuenta que el número máximo no está limitado.',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_NOTICE_EXPLAIN'		=> 'Si está activado, se mostrará un aviso de cookie a los usuarios cuando visiten su foro. Esto puede ser requerido por ley dependiendo del contenido de su foro y de las extensiones habilitadas.',
...
$lang = array_merge($lang, array(
 	...
 	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Está página permite a los usuarios enviar emails a los Administradores del foro. Tenga en cuenta que la opción de correos electrónicos en todo el foro debe estar habilitada también. Puede encontrar esta opción en General &gt; Comunicación Cliente &gt; Configuración de email.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Cada proveedor OAuth requiere un secreto y la clave única para identificarse con el servidor externo. Estos deben ser suministrados por el servicio OAuth al registrar su sitio web, y deben introducirse exactamente como se lo proporcionarón.<br>Cualquier servicio que no su clave y su secreto introducido aquí, no estará disponible para los usuarios del foro. También tenga en cuenta, que el usuario aún puede registrarse e identificarse utilizando la autenticación del plug-in de base de datos.',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Clave',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Secreto',

	'APACHE_SETUP_BEFORE_USE'	=> 'Debe configurar la autenticación de Apache antes de cambiar phpBB a este método de autenticación. Tenga en cuenta que el nombre de usuario que usa para la autenticación de apache debe ser el mismo que su nombre de usuario phpBB. La autenticación de Apache solo se puede usar con mod_php (no con una versión CGI).',
...
$lang = array_merge($lang, array(
	...
	'USE_SYSTEM_CRON'		=> 'Ejecutar tareas periódicas desde el cron del sistema operativo',
	'USE_SYSTEM_CRON_EXPLAIN'		=> 'Si se desactiva, phpBB hará que las tareas periódicas se ejecuten automáticamente. Cuando está habilitado, phpBB no programará ninguna tarea periódica por sí mismo; un administrador del sistema debe hacer que <code>bin/phpbbcli.php cron:run</code> sea ejecutado por la herramienta cron del sistema operativo a intervalos regulares (por ejemplo, cada 5 minutos).',
));
...
$lang = array_merge($lang, array(
	...
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Si es necesario, configure esto para que no exceda el número máximo de destinatarios que su servidor de correo electrónico permitirá en un mensaje de correo electrónico.',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'No proporcione un protocolo (<samp>ssl://</samp> o <samp>tls://</samp>) a menos que su servidor de correo le indique que lo haga.',
