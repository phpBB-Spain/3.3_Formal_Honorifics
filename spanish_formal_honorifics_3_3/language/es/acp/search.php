...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_SPHINX_CONFIG_FILE_EXPLAIN'	=> 'El contenido generado en el archivo de configuración de Sphinx. Estos datos necesitan ser copiados en el sphinx.conf para ser usado por la búsqueda de Sphinx. Reemplace el [dbuser] y [dbpassword] con sus credenciales de base de datos.',
	...
	'SEARCH_STORE_RESULTS'					=> 'Duración de la caché de resultados de búsquedas',
	'SEARCH_STORE_RESULTS_EXPLAIN'			=> 'Resultados de búsquedas cacheados expiran transcurrido este intervalo, en segundos. 0 significa deshabilitar la caché de búsquedas.',
	'SEARCH_TYPE'							=> 'Motor de búsqueda',
	'SEARCH_TYPE_EXPLAIN'					=> 'phpBB le permite elegir el motor que se utiliza para buscar texto en el contenido de los mensajes. Por defecto la búsqueda emplea la búsqueda de texto completo nativa.',
