...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Para más información sobre configuración y administración de permisos en su foro phpBB3, por favor vea la sección <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">Configuración de los permisos de nuestra Guía de Inicio Rápido</a> (web oficial en inglés).</p>
	',

	'ACL_NEVER'				=> 'Nunca',
	'ACL_SET'				=> 'Configurar permisos',
	'ACL_SET_EXPLAIN'		=> 'Los permisos están basados en un sencillo sistema <strong>SI</strong>/<strong>NO</strong>. Configurar una opción como <strong>NUNCA</strong> para un usuario o grupo tiene preferencia sobre cualquier otro valor asignado. Si no quiere asignar un valor a una opción para este usuario o grupo, seleccione <strong>NO</strong>. Valores asignados para esta opción en cualquier lugar se usarán preferentemente, en caso contrario se asume <strong>NUNCA</strong>. Todos los objetos marcados (en su respectivo checkbox) copiarán el paquete de permisos que defina. Tenga en cuenta que configurar permisos administrativos para las cuentas de los fundadores no tiene ningún efecto, ya que los permisos de administrador siempre están configurados en <strong>SÍ</strong> para los fundadores.',
