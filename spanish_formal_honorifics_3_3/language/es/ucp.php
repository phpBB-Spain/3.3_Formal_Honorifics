...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Al ingresar en “%1$s” (de aquí en adelante “nosotros”, “nos”, “nuestro”, “%1$s”, “%2$s”), usted acuerda estar legalmente sometido a los siguientes términos. En caso contrario por favor no se registre y/o use “%1$s”. Podemos cambiar estos términos en cualquier momento e intentaríamos avisarle, sin embargo sería prudente que los revisase por su cuenta periódicamente. Seguir registrado a “%1$s” después de esos cambios significa que acuerda estar legalmente sometido a esos nuevos términos tal como fueron actualizados y/o reformados.<br>
	<br>
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'Gracias por registrarse, su cuenta ha sido creada.',
	...
	'ATTACHMENT_LOCKED'				=> 'Este tema está cerrado, no puede eliminar el archivo adjunto.',
	...
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Gravatar es un servicio que le permite mantener el mismo avatar en múltiples sitios web. Visite <a href="http://www.gravatar.com/">Gravatar</a> para más información.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Galería de Avatares',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Usted puede elegir su avatar de un conjunto de avatares disponibles a nivel local.',
	...
	'AVATAR_PAGE'					=> 'Pagína',
	'AVATAR_SELECT'					=> 'Seleccione su avatar',
	...
	'CANNOT_MOVE_TO_SAME_FOLDER'	=> 'Los mensajes no pueden ser movidos a la carpeta que quiere borrar.',
	...
	'CANNOT_REMOVE_FOLDER'			=> 'Esta carpeta no puede ser eliminada.',
	'CHANGE_DEFAULT_GROUP'			=> 'Cambiar grupo por defecto',
	'CHANGE_PASSWORD'				=> 'Cambiar contraseña',
	'CLICK_GOTO_FOLDER'				=> '%1$sIr a la carpeta “%3$s” %2$s',
	'CLICK_RETURN_FOLDER'			=> '%1$sVolver a su  carpeta de “%3$s”%2$s',
	...
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Para cambiar su contraseña, su dirección de correo electrónico o su nombre de usuario, debe introducir su contraseña actual.',
	'CUR_PASSWORD_EMPTY'	    	=> 'Usted no ha ingresado su contraseña actual.',
	...
	'DELETE_MESSAGES_IN_FOLDER'		=> 'Borrar todos los mensajes en la carpeta eliminada',
	'DELETE_RULE'					=> 'Eliminar regla',
	'DELETE_RULE_CONFIRM'			=> '¿Está seguro de que quiere eliminar esta regla?',
	'DEMOTE_SELECTED'				=> 'Deponer responsabilidad',
	...
	'FOLDER_NAME_EMPTY'			=> 'Debe introducir un nombre para esta carpeta.',
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'La carpeta está %3$d%% llena (%2$d de %1$s guardado)',
		2	=> 'La carpeta está %3$d%% llena (%2$d de %1$s guardados)',
	),
	...
	'FULL_FOLDER_OPTION_CHANGED'	=> 'La acción a tomar cuando una carpeta llena ha sido cambiada correctamente',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Introduzca la dirección de correo electrónico que utilizó para registrar su cuenta en <a href="http://www.gravatar.com/">Gravatar</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Dimensiones de avatar',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Especifique el ancho y la altura del avatar, o dejelo en blanco para tratar de verificarlo automáticamente.',
	...
	'JOIN_SELECTED'					=> 'Unirse al grupo seleccionado',
	...
	'LOGIN_LINK'					=> 'Enlace o registre su cuenta en un servicio externo con su cuenta del foro',
	'LOGIN_LINK_EXPLAIN'			=> 'Ha intentado iniciar sesión con un servicio externo que aún no está conectado a una cuenta en este foro. Ahora debe vincular esta cuenta a una cuenta existente, o crear una nueva cuenta.',
	'LOGIN_LINK_MISSING_DATA'		=> 'Los datos necesarios para vincular su cuenta con un servicio externo no están disponibles. Por favor, reinicie el proceso de inicio de sesión.',
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'No se han facilitado datos a esta página para enlazar una cuenta externa a una cuenta del foro. Por favor, póngase en contacto con el Administrador del foro, si sigue teniendo problemas.',
	...
	'MAX_FOLDER_REACHED'			=> 'Alcanzado el número máximo permitido de carpetas definidas por el usuario',
	...
	'MOVE_DELETED_MESSAGES_TO'		=> 'Mover mensajes de la carpeta eliminada a',
	'MOVE_DOWN'						=> 'Bajar',
	'MOVE_MARKED_TO_FOLDER'			=> 'Mover marcados a %s',
	'MOVE_PM_ERROR'					=> array(
	    1	=> 'Ha ocurrido un error mientras movía los mensajes a la nueva carpeta, sólo %2$d de %1$s  fue movido.',
		2	=> 'Ha ocurrido un error mientras movía los mensajes a la nueva carpeta, sólo %2d de %1$s fueron movidos.',
	),
	...
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> '¿Está seguro de que quiere marcar todas las Notificaciones como leídas?',
	...
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Alguien ha respondido a un tema que tiene como Favorito',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Alguien ha requerido unirse a un grupo del que es responsable',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'Un mensaje o tema necesita aprobación',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'   				=> 'Sus temas/mensajes han sido aprobados o desaprobados por un Moderador',
	'NOTIFICATION_TYPE_PM'								=> 'Alguien le ha enviado un mensaje privado',
	'NOTIFICATION_TYPE_POST'							=> 'Alguien ha respondido a un tema al que está suscrito',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Alguien le citó en un mensaje',
	'NOTIFICATION_TYPE_REPORT'							=> 'Alguien reporto un mensaje',
	'NOTIFICATION_TYPE_TOPIC'				   			=> 'Alguien creó un nuevo tema en un foro al que está suscrito',
	...
	'NOT_ADDED_FRIENDS_BOTS'		=> 'No puede añadir robots a su lista de amigos.',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Tiene %d mensaje privado actualmente en espera porque su carpeta está llena.',
		2	=> 'Tiene %d mensajes privados actualmente en espera porque su carpeta está llena.',
	),
	...
	'NO_AUTH_PROFILEINFO'			=> 'No está autorizado a cambiar la información de su perfil.',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'No está autorizado a imprimir mensajes privados.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'El correo electrónico que ha especificado es utilizado por varios usuarios. Debe especificar el nombre de usuario también.',
	...
	'NO_NEW_FOLDER_NAME'		=> 'Debe especificar un nombre para la carpeta',
	...
	'NO_RESET_TOKEN'			=> 'No proporcionó un token de restablecimiento de contraseña.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'La contraseña debe tener al menos %1$s de longitud, debe contener letras en mayúsculas y minúsculas y debe contener números.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Debe tener al menos %1$s de longitud.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'La contraseña debe tener al menos %1$s de longitud y debe contener letras en mayúsculas y minúsculas.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'La contraseña debe tener al menos %1$s de longitud, debe contener letras en mayúsculas y minúsculas, debe contener números y símbolos.',
	'PASSWORD'					=> 'Contraseña',
	'PASSWORD_ACTIVATED'		=> 'Su nueva contraseña ha sido activada.',
	'PASSWORD_RESET'			=> 'Su contraseña se ha restablecido correctamente.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Si su cuenta existe, se envió un enlace de restablecimiento de contraseña a su dirección de correo electrónico registrada. Si no recibe un correo electrónico, puede deberse a que está excluido, su cuenta no está activada, ha solicitado múltiples restablecimientos de contraseña en un corto período de tiempo, o no puede cambiar su contraseña. Póngase en contacto con un Administrador si se aplica alguno de esos motivos. Además, verifique su filtro de spam.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Las claves de acceso "Recordar" permite que se conecte automáticamente cuando usted visita el foro. Si cierra la sesión, el recuerdo de clave se elimina sólo en el equipo que se utiliza para cerrar la sesión. Aquí puede ver claves de acceso creadas en otros equipos que utiliza para acceder a este sitio.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'No existen claves de sesión guardadas de "Recordar".',

	'RECIPIENT'				=> 'Destinatario',
	'RECIPIENTS'			=> 'Destinatarios',
	'REGISTRATION'			=> 'Registro',
	'OAUTH_REGISTRATION'				=> 'Registro utilizando servicios externos',
	'RELEASE_MESSAGES'		=> '%sEnviar todos los mensajes en espera%s… serán reordenados en sus carpetas correspondientes si hay suficiente espacio disponible.',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'El token de restablecimiento de contraseña que proporcionó no es válido o ha caducado.',
	...
	'SIGNATURE_PREVIEW'			=> 'Su firma se verá así en los mensajes',
	'SIGNATURE_TOO_LONG'		=> 'Su firma es muy larga.',
	'SELECT_CURRENT_TIME'		=> 'Seleccione la hora actual',
	'SELECT_TIMEZONE'			=> 'Seleccione su zona horaria',
	'SORT'						=> 'Ordenar',
	...
	'UCP_AUTH_LINK_ASK'			=> 'Usted actualmente no tiene una cuenta asociada a este servicio externo. Haga clic en el botón de abajo para enlazar su cuenta del foro a una cuenta con este servicio externo.',
	...
	'UCP_AUTH_LINK_TITLE'		=> 'Administre sus asociaciones de cuentas externas',
	...
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> 'Aquí puede ver todas las notificaciones anteriores.',
	'UCP_NOTIFICATION_OPTIONS'			=> 'Editar opciones de Notificación',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Aquí puede ajustar sus métodos de Notificación preferidas para el foro.',
	...
	'UCP_PM_OPTIONS'		=> 'Reglas, carpetas y configuración',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'La funcionalidad de restablecimiento de contraseña ha sido desactivada. Si necesita ayuda para acceder a su cuenta, por favor póngase en contacto con el %sAdministrador del Foro%s',
	...
	'PM_ACTION'	=> array(
		'PLACE_INTO_FOLDER'	=> 'Mover a carpeta',
	...
	'GROUP_NONMEMBER'	=> 'No miembro',
	'GROUP_DETAILS'		=> 'Detalles del Grupo',

	'NO_LEADER'		=> 'Sin responsable',
